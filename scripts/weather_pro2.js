...
let config = {
    ...
    lang: "ja", //语言,随意切换为您想要的语言哦(zh/zh-tw/ja/en/fr/...)
...
const provider = {
    heweather_now: {
        api: `https://free-api.heweather.net/s6/weather/now?location=${config.lon_lat.replace(/\s/g, "").replace("，", ",")}&key=${config.huweather_apiKey}&lang=${config.lang}`,
    ...
    heweather_daily: {
        api: `https://free-api.heweather.net/s6/weather/forecast?location=${config.lon_lat.replace(/\s/g, "").replace("，", ",")}&key=${config.huweather_apiKey}&lang=${config.lang}`,
        progress: 0,
        timeoutNumber: 0,
        data: {},
    ...
    heweather_air: {
        api: `https://free-api.heweather.net/s6/air/now?location=auto_ip&key=${config.huweather_apiKey}&lang=${config.lang}`,
        progress: 0,
        timeoutNumber: 0,
        data: {},
        support: []
    ...
    heweather_lifestyle: {
        api: `https://free-api.heweather.net/s6/weather/lifestyle?location=${config.lon_lat.replace(/\s/g, "").replace("，", ",")}&key=${config.huweather_apiKey}&lang=${config.lang}`,
        progress: 0,
        timeoutNumber: 0,
        data: [],
        support: ['$[lifeStyle]']
