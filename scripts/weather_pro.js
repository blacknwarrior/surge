...
const provider = {
    heweather_now: {
        api: `https://free-api.heweather.net/s6/weather/now?location=${config.lon_lat.replace(/\s/g, "").replace("，", ",")}&key=${config.huweather_apiKey}`,
    ...
    heweather_daily: {
        api: `https://free-api.heweather.net/s6/weather/forecast?location=${config.lon_lat.replace(/\s/g, "").replace("，", ",")}&key=${config.huweather_apiKey}`,
        progress: 0,
        timeoutNumber: 0,
        data: {},
    ...
    heweather_lifestyle: {
        api: `https://free-api.heweather.net/s6/weather/lifestyle?location=${config.lon_lat.replace(/\s/g, "").replace("，", ",")}&key=${config.huweather_apiKey}`,
        progress: 0,
        timeoutNumber: 0,
        data: [],
        support: ['$[lifeStyle]']
